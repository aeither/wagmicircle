const PoolGuardianAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "self", type: "address" },
      {
        indexed: true,
        internalType: "string",
        name: "shortName",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "stakedToken", type: "address" },
      { internalType: "address", name: "strToken", type: "address" },
      {
        internalType: "enum IPoolGuardian.PoolStatus",
        name: "stateFlag",
        type: "uint8",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "_levelScoresDef", type: "uint256[]" },
      {
        internalType: "uint256[]",
        name: "_leverageThresholds",
        type: "uint256[]",
  ...
  {
    inputs: [
      { internalType: "address", name: "newWrapRouter", type: "address" },
    ],
    name: "setWrapRouter",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "multiSigWallet", type: "address" },
    ],
    name: "transferSavior",
    outputs: [],
    stateMutability: "nonpayable",
